...
df_plot = df.dropna(subset=["YearsOfExperience", "CurrentSalaryAmount"])
df_plot = df_plot[df_plot["CurrentSalaryAmount"] > 10000]
df_plot = df_plot[df_plot["CurrentSalaryAmount"] < 500000]
...
corr_exp = df_plot["YearsOfExperience"].corr(df_plot["CurrentSalaryAmount"])
...
ax2.scatter(members["YearsOfExperience"], members["CurrentSalaryAmount"], alpha=0.4, s=14, label="Members")
ax2.scatter(non_members["YearsOfExperience"], non_members["CurrentSalaryAmount"], alpha=0.4, s=14, label="Non-Members")
...
member_salary_gap = members["CurrentSalaryAmount"].mean() - non_members["CurrentSalaryAmount"].mean()
...
ax3.scatter(certified["YearsOfExperience"], certified["CurrentSalaryAmount"], alpha=0.4, s=14, label="Certified")
ax3.scatter(not_certified["YearsOfExperience"], not_certified["CurrentSalaryAmount"], alpha=0.4, s=14, label="Non-Certified")
...
cert_salary_gap = certified["CurrentSalaryAmount"].mean() - not_certified["CurrentSalaryAmount"].mean()
